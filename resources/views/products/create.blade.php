                    ...
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="dec" id="dec" rows="4"
                                class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm">{{ old('dec') }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <a href="{{ route('products.index') }}" class="text-gray-500 hover:text-gray-700">Cancel</a>
                            </div>
                    </form>
